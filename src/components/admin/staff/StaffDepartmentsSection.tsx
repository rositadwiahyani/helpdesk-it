...
interface StaffDepartmentsSectionProps {
  onTabChange: (tab: StaffTab) => void;
}

export default function StaffDepartmentsSection({
  onTabChange,
  ...
  return (
    <div className="flex flex-col items-start bg-linear-[0deg,#F9F9FC0%,#F9F9FC100%),#FF] min-w-screen min-h-screen relative">
      <div className="flex min-h-[1024px] pl-72 justify-center items-start w-full">
        <div className="flex min-h-[1024px] flex-col items-start w-full h-full">
          ...
          <div className="flex p-6 flex-col items-start gap-6 w-full">
            <div className="flex pb-2 flex-col items-start w-full">
              <div className="flex flex-col items-start w-full">
                <p className="text-[#001E40] font-iBMPlexSans text-2xl font-bold leading-8 w-full tracking-[-0.01em]">
                  Manajemen Staff
                </p>
              </div>
              <div className="flex flex-col items-start w-full">
            ...
            <div className="flex items-start gap-8 border-b border-b-[#C3C6D1] w-full">
              <button
                ...
                className="cursor-pointer text-nowrap flex pt-px pr-1 pb-[13px] pl-1 flex-col justify-center items-center w-fit"
              >
                <p className="text-[#43474F] font-iBMPlexSans text-base font-medium leading-6 w-fit">
                  Agents
                </p>
              </button>
              <button
              ...
              <button
                ...
                className="cursor-pointer text-nowrap flex pt-0 pr-1 pb-3 pl-1 flex-col justify-center items-center border-b-2 border-b-[#0059BB] w-fit"
              >
                <p className="text-[#0059BB] font-iBMPlexSans text-base font-bold leading-6 w-fit">
                  Departments
                </p>
              </button>
            </div>
            <div className="flex flex-col items-start rounded-sm border border-[#C3C6D1] bg-[#FFF] shadow-[01px2px0rgba(0,0,0,0.05)] w-full overflow-hidden">
              <div className="flex p-4 justify-between items-center border-b border-b-[#C3C6D1] bg-[#FFF] w-full">
                <div className="flex flex-col items-start w-fit">
                ...
                <div className="flex items-start gap-2 w-fit">
                  <div className="flex py-[9px] px-4 items-center gap-2 rounded bg-[#001E40] w-fit">
                    <svg
                      width="9"
                      height="9"
                      viewBox="0 0 9 9"
                  ...
                  <div className="flex py-2 px-4 items-center gap-2 rounded border border-[#C3C6D1] bg-[#F9F9FC] w-fit">
                    <svg
                      width="10"
                      height="3"
                      viewBox="0 0 10 3"
                    ...
                    >
                      <path
                        d="M1.16667 2.33333C0.845833 2.33333 0.571181 2.2191 0.342708 1.99063C0.114236 1.76215 0 1.4875 0 1.16667C0 0.845833 0.114236 0.571181 0.342708 0.342708C0.571181 0.114236 0.845833 0 1.16667 0C1.4875 0 1.76215 0.114236 1.99063 0.342708C2.2191 0.571181 2.33333 0.845833 2.33333 1.16667C2.33333 1.4875 2.2191 1.76215 1.99063 1.99063C1.76215 2.2191 1.4875 2.33333 1.16667 2.33333ZM4.66667 2.33333C4.34583 2.33333 4.07118 2.2191 3.84271 1.99063C3.61424 1.76215 3.5 1.4875 3.5 1.16667C3.5 0.845833 3.61424 0.571181 3.84271 0.342708C4.07118 0.114236 4.34583 0 4.66667 0C4.9875 0 5.26215 0.114236 5.49062 0.342708C5.7191 0.571181 5.83333 0.845833 5.83333 1.16667C5.83333 1.4875 5.7191 1.76215 5.49062 1.99063C5.26215 2.2191 4.9875 2.33333 4.66667 2.33333ZM8.16667 2.33333C7.84583 2.33333 7.57118 2.2191 7.34271 1.99063C7.11424 1.76215 7 1.4875 7 1.16667C7 0.845833 7.11424 0.571181 7.34271 0.342708C7.57118 0.114236 7.84583 0 8.16667 0C8.4875 0 8.76215 0.114236 8.99063 0.342708C9.2191 0.571181 9.33333 0.845833 9.33333 1.16667C9.33333 1.4875 9.2191 1.76215 8.99063 1.99063C8.76215 2.2191 8.4875 2.33333 8.16667 2.33333Z"
                        fill="#1A1C1E"
                      />
                    </svg>
              ...
              <div className="flex flex-col items-start -space-y-px w-full overflow-hidden">
                <div className="flex pr-4 justify-center items-center gap-4 border-b border-b-[#C3C6D1] bg-[#F3F3F6] w-full">
                  <svg
                    width="48"
                    height="57"
                    viewBox="0 0 48 57"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="flex pt-[22px] pr-4 pb-[19px] pl-4 flex-col items-center w-12 "
                  >
                    <rect
                      x="16.5"
                      y="22.3"
                  ...
                  <div className="flex items-center gap-1 w-[229px]">
                  ...
                  <div className="flex pl-4 items-center gap-1 w-20">
                    <p className="text-[#43474F] font-iBMPlexSans text-xs font-semibold leading-4 w-fit tracking-[0.05em]">
                      TYPE
                    </p>
                    <svg
                  ...
                  <div className="flex pl-4 items-center gap-1 w-[101px]">
                    <p className="text-[#43474F] font-iBMPlexSans text-xs font-semibold leading-4 w-fit tracking-[0.05em]">
                      AGENTS
                    </p>
                    <svg
                  ...
                  <div className="flex pl-4 items-center gap-1 w-[161px]">
                    <p className="text-[#43474F] font-iBMPlexSans text-xs font-semibold leading-4 w-fit tracking-[0.05em]">
                      EMAIL ADDRESS
                    </p>
                    <svg
                  ...
                  <div className="flex pl-4 items-center gap-1 w-[115px]">
                    <p className="text-[#43474F] font-iBMPlexSans text-xs font-semibold leading-4 w-fit tracking-[0.05em]">
                      MANAGER
                    </p>
                    <svg
                ...
                <div className="flex flex-col items-start -space-y-px w-full">
                  <div className="flex justify-center items-start w-full">
                    ...
                    <div className="flex pt-5 pr-4 pb-[18px] pl-4 flex-col items-start w-[261px]">
                      <p className="text-[#1A1C1E] font-iBMPlexSans text-sm font-bold leading-5 w-fit">
                        Unit Hardware &amp; Perangkat
                      </p>
                    </div>
                    <div className="flex pt-[22px] pr-4 pb-[17px] pl-4 flex-col items-start w-[113px]">
                      <div className="flex py-0.5 px-2 items-center rounded-sm bg-[#E6F4EA] w-fit">
                        <p className="text-[#1E7E34] font-iBMPlexSans text-[10px] font-bold leading-[15px] w-fit tracking-[0.025em]">
                          ACTIVE
                        </p>
                      </div>
                    </div>
                    <div className="flex py-[19px] px-4 flex-col items-start w-24">
                      <p className="text-[#43474F] font-iBMPlexSans text-sm leading-5 w-fit">
                        Public
                      </p>
                    </div>
                    <div className="flex pt-5 pr-4 pb-[18px] pl-4 flex-col items-start w-[117px]">
                      <p className="text-[#001E40] font-iBMPlexSans text-sm font-bold leading-5 w-fit">
                        1
                      </p>
                    </div>
                    <div className="flex py-[19px] px-4 flex-col items-start opacity-60 w-[177px]">
                      <p className="text-[#43474F] font-iBMPlexSans text-sm leading-5 w-fit">
                        None
                      </p>
                    </div>
                    <div className="flex py-[19px] px-4 flex-col items-start opacity-60 w-[131px]">
                      <p className="text-[#43474F] font-iBMPlexSans text-sm leading-5 w-fit">
                        None
                      </p>
                    </div>
                  </div>
                  <div className="flex justify-center items-start border-t border-t-[#C3C6D1] w-full">
                    <svg
                      width="48"
                      height="57"
                      viewBox="0 0 48 57"
                  ...
                  <div className="flex justify-center items-start border-t border-t-[#C3C6D1] w-full">
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="flex pt-[22px] pr-4 pb-[18px] pl-4 flex-col items-center w-12 "
                    >
                      <rect
                        x="16.4941"
                        y="22.88"
                    ...
                    <div className="flex pt-5 pr-4 pb-[17px] pl-4 flex-col items-start w-[261px]">
                      <p className="text-[#1A1C1E] font-iBMPlexSans text-sm font-bold leading-5 w-fit">
                        Unit Software &amp; Aplikasi
                      </p>
                    </div>
                    <div className="flex pt-[22px] pr-4 pb-4 pl-4 flex-col items-start w-[113px]">
                      <div className="flex py-0.5 px-2 items-center rounded-sm bg-[#E6F4EA] w-fit">
                        <p className="text-[#1E7E34] font-iBMPlexSans text-[10px] font-bold leading-[15px] w-fit tracking-[0.025em]">
                          ACTIVE
                        </p>
                    ...
                    <div className="flex pt-[19px] pr-4 pb-[18px] pl-4 flex-col items-start w-24">
                      <p className="text-[#43474F] font-iBMPlexSans text-sm leading-5 w-fit">
                        Public
                      </p>
                    </div>
                    <div className="flex pt-5 pr-4 pb-[17px] pl-4 flex-col items-start w-[117px]">
                      <p className="text-[#001E40] font-iBMPlexSans text-sm font-bold leading-5 w-fit">
                        1
                      </p>
                    </div>
                    <div className="flex pt-[19px] pr-4 pb-[18px] pl-4 flex-col items-start opacity-60 w-[177px]">
                      <p className="text-[#43474F] font-iBMPlexSans text-sm leading-5 w-fit">
                        None
                      </p>
                    </div>
                    <div className="flex pt-[19px] pr-4 pb-[18px] pl-4 flex-col items-start opacity-60 w-[131px]">
                      <p className="text-[#43474F] font-iBMPlexSans text-sm leading-5 w-fit">
                        None
                      </p>
                    </div>
              ...
              <div className="flex p-4 items-center gap-4 border-t border-t-[#C3C6D1] bg-[#F3F3F6] w-full">
                ...
                <div className="flex items-start gap-3 w-fit">
                  <button className="cursor-pointer text-nowrap flex flex-col justify-center items-center w-fit">
                    <p className="text-[#0059BB] font-iBMPlexSans text-[13px] font-bold leading-[18px] w-fit">
                      All
                    </p>
                  </button>
                  <button className="cursor-pointer text-nowrap flex flex-col justify-center items-center w-fit">
            ...
            <div className="flex pt-2 justify-center items-start gap-6 w-full">
              <div className="flex p-4 items-center gap-4 rounded-sm border border-[#C3C6D1] bg-[#FFF] w-[299px]">
                <div className="flex justify-center items-center shrink-0 rounded-xl bg-[rgba(0,112,234,0.20)] w-12 h-12">
                  <svg
                    width="20"
                    height="18"
                    viewBox="0 0 20 18"
              ...
              <div className="flex p-4 items-center gap-4 rounded-sm border border-[#C3C6D1] bg-[#FFF] w-[299px]">
                <div className="flex justify-center items-center shrink-0 rounded-xl bg-[rgba(0,51,102,0.20)] w-12 h-12">
                  <svg
                    width="24"
                    height="12"
                    viewBox="0 0 24 12"
              ...
              <div className="flex p-4 items-center gap-4 rounded-sm border border-[#C3C6D1] bg-[#FFF] w-[299px]">
                <div className="flex justify-center items-center shrink-0 rounded-xl bg-[rgba(153,156,159,0.10)] w-12 h-12">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
      ...
      <div className="flex flex-col justify-between items-start absolute bg-[#001E40] w-72 h-full">
        ...
        <div className="flex pt-[466px] pr-6 pb-6 pl-6 flex-col items-start shrink-0 border-t border-t-[rgba(255,255,255,0.10)] w-full h-[514px]">
