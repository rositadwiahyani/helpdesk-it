...
export default function TicketToolbar({
  ...
  const handleBulkAction = (action: string) => {
    if (selectedCount === 0) {
      ...
      alert(`Menjalankan aksi bulk '${action}' untuk ${selectedCount} tiket.`);
    }
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 w-full">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <div className="flex gap-1">
            ...
            <button onClick={() => handleBulkAction('Assign')} className="p-2 border border-[#C3C6D1] rounded hover:bg-gray-50 text-gray-700 relative group" title="Assign">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          {/* Date Range Picker */}
          <div className="flex py-2 px-3 items-center gap-2 rounded border border-[#C3C6D1] bg-[#FFF] cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <span className="text-[#43474F] font-iBMPlexSans text-xs font-semibold leading-4">Any Date</span>
          </div>
