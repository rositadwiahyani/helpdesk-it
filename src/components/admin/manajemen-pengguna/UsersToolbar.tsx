...
export default function UsersToolbar({
  ...
  return (
    <div className="flex flex-col md:flex-row p-4 gap-4 justify-between items-center rounded-lg border border-[#C3C6D1] bg-[#FFF] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] w-full">
      ...
      <div className="flex flex-col items-start w-full md:flex-1 relative">
      ...
      <div className="flex items-center gap-3 w-full md:w-auto shrink-0">
        ...
        <button onClick={onAddClick} className="cursor-pointer text-nowrap flex py-2.5 px-4 justify-center items-center gap-2 rounded bg-[#001E40] hover:bg-[#00142d] transition-colors">
          ...
          <p className="text-[#FFF] font-iBMPlexSans text-xs font-semibold leading-4 tracking-[0.05em]">Tambah Pelapor</p>
        </button>
      </div>
    </div>
  );
