  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 justify-between items-center w-full">
      ...
      <div className="flex items-center gap-3 w-full md:w-auto shrink-0">
        {selectedCount > 0 && (
          <button onClick={onBulkDeleteClick} className="cursor-pointer text-nowrap flex py-2 px-4 justify-center items-center gap-2 rounded border border-red-500 bg-red-50 hover:bg-red-100 transition-colors group">
            ...
            <p className="text-red-500 font-iBMPlexSans text-sm font-semibold leading-5 tracking-[0.05em] group-hover:text-red-600">Hapus ({selectedCount})</p>
          </button>
        )}
