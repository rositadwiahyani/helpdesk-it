  ...
  return (
    <div className="flex flex-col md:flex-row justify-start items-stretch gap-6 w-full">
      ...
      <div className="flex p-4 justify-between items-center rounded-lg border border-[#C3C6D1] bg-[#FFF] w-full max-w-sm">
        ...
        <div className="flex justify-center items-center shrink-0 rounded-xl bg-[#D5E3FF] w-12 h-12">
      ...
      <div className="flex p-4 justify-between items-center rounded-lg border border-[#C3C6D1] bg-[#FFF] w-full max-w-sm">
        ...
        <div className="flex justify-center items-center shrink-0 rounded-xl bg-[#FFF8E7] w-12 h-12">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7D5100" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>
        </div>
      </div>
    </div>
  );
