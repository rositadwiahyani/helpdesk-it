...
export default function TeknisiProfilePage() {
  ...
  const initials = formData.name ? formData.name.substring(0, 2).toUpperCase() : 'TK';
  ...
  return (
    <div className="flex flex-col gap-6 p-6 md:p-10">
      <div>
        <h2 className="text-2xl font-bold text-[var(--ink)] mb-1">Profil Teknisi</h2>
      ...
      <div className="bg-white rounded-2xl border border-[var(--line)] shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-300 -mt-2">
        <div className="p-5 md:p-6 border-b border-[var(--line-dark)]">
          <h3 className="font-bold text-[18px] text-[var(--ink)]">Informasi Akun</h3>
        </div>
            ...
            <div className="flex flex-col gap-8 animate-in fade-in duration-300">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="md:col-span-1 flex flex-col items-center gap-3 pt-2">
                  ...
                  <button type="button" className="text-[13px] font-bold text-[var(--gold-soft)] hover:text-[var(--gold-dim)] transition-colors">Ubah Avatar</button>
                </div>
                <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="flex flex-col gap-2">
                    <label className="text-[13px] font-bold text-[var(--ink)]">Nama Lengkap</label>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[13px] font-bold text-[var(--ink)]">No. Telepon / Extension</label>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[13px] font-bold text-[var(--ink)]">No. HP / WhatsApp</label>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:grid-cols-4">
                  ...
                  <div className="flex flex-col gap-2 md:col-span-2 sm:col-span-1">
                    <label className="text-[13px] font-bold text-[var(--ink)]">Ganti Password</label>
                    <input type="password" name="password" value={formData.password} onChange={handleChange} placeholder="Biarkan kosong jika tidak ingin mengubah" className="bg-[var(--paper)] border border-[var(--line-dark)] rounded-xl px-4 py-2.5 text-[14px] focus:outline-none focus:border-[var(--gold-soft)] transition-colors w-full" />
                  </div>
                </div>
              </div>
            </div>
