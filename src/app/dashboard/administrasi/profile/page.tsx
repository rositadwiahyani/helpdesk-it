    ...
    <div className="flex flex-col gap-6 p-6 md:p-10">
      ...
      <div className="bg-white rounded-2xl border border-[var(--line)] shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-300">
        ...
        <form onSubmit={handleSave}>
          ...
          <div className="bg-[var(--paper-2)]/50 border-t border-[var(--line)] p-5 md:p-6 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 w-full">
            <button type="button" onClick={() => window.location.reload()} className="w-full sm:w-auto bg-white border border-[var(--line)] text-[var(--text-dim)] px-7 py-2.5 rounded-xl text-sm font-bold hover:bg-[var(--paper-2)] transition-colors active:scale-95">
              {t('common.reset')}
            </button>
            <button type="submit" disabled={isSaving} className="w-full sm:w-auto bg-[var(--ink)] text-white px-7 py-2.5 rounded-xl text-sm font-bold shadow-sm hover:bg-[var(--text)] hover:shadow-md transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed">
