  ...
  if (!ticket) {
    return (
      <div className="p-16 text-center">
        ...
        <Link href="/dashboard/operator/tickets" className="text-[var(--gold)] font-bold mt-2 inline-block">
          Back to Tickets
        </Link>
      </div>
    );
    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-300 p-6">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2 text-[13px] font-bold text-[var(--text-dim)]">
          <Link href="/dashboard/operator/tickets" className="hover:text-[var(--ink)] transition-colors">Tickets</Link>
          <span>/</span>
